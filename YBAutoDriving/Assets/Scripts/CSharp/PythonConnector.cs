...
public class PythonConnector : MonoBehaviour
{
    ...
    protected void SendMessageToPython(byte[] message)
    {
        //向Python发送识别指令
        //message = Encoding.ASCII.GetBytes("CarSpeed: " + 100f * car.delta.magnitude * car.timescale);
    ...
    protected virtual event OnDataReceivedEventHandler DataReceived;
